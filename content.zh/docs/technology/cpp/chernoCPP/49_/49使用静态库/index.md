...
| 方式 | 搜索顺序 | 适用场景 |
| :--- | :--- | :--- |
| **`#include "..."`** (双引号) | 1. **当前源文件所在的目录**。<br>2. 项目设置中的“附加包含目录”。<br>3. 系统标准库目录。 | 程序员自己写的头文件，或者放在项目文件夹内的第三方库。 |
| **`#include <...>`** (尖括号) | 1. 项目设置中的“附加包含目录”。<br>2. **系统标准库目录**（如 `iostream`）。<br>3. 编译器通常跳过当前目录搜索。 | 标准库（STL）或已经安装到系统路径下的第三方库。 |
