...
![](img/7e706d7e1a6469ffff714243a764471e_MD5.jpg)
...
![](img/0ff61bc69a3f91e6fabb3a2df05a462c_MD5.jpg)
...
![](img/e43d3d987ebdd82562ef1c84840b9673_MD5.jpg)
...
![](img/25eb378b72e565222b68962a1b938e16_MD5.jpg)

`TTL`是该记录的生存时间，它决定了资源记录应当从缓存中删除的时间。

`Name`和`Value`字段的取值取决于`Type`：

![](img/11babdf6cc9869061a7472a9b0cf88db_MD5.jpg)
