...
![握手建立连接流程](img/4a0a89f782c835961c5cabd45cbd56f1_MD5.webp)
...
![TCP是什么](img/ed2f1e22c792bcf8751eeb3cb558e1d3_MD5.webp)
...
![01二进制字节流](img/63bef4753ea1a40cbf0b6a89e2583471_MD5.webp)

正因为这个没有任何边界的特点，所以当我们选择使用 TCP 发送 =="夏洛"和"特烦恼"== 的时候，接收端收到的就是 =="夏洛特烦恼"== ，这时候接收端没发区分你是想要表达 =="夏洛"+"特烦恼"== 还是 =="夏洛特"+"烦恼"== 。

![消息对比](img/dd36767368efbbe01a45ff950cfb9e98_MD5.webp)
...
![消息边界长度标志](img/87afcedbbbb4f86f979f1d1bc9249fa9_MD5.webp)
...
![四层网络协议](img/f6b67865b182e5cbe70db097ecb69acd_MD5.webp)
...
![HTTP调用](img/22da2f9fdaad911ea939d16ebd679973_MD5.webp)
...
![RPC可以像调用本地方法那样调用远端方法](img/2c9ae905c88ea4e19f2ed53b9840887a_MD5.webp)
...
![connection_pool](img/8b1e763013c3ae839fc149c85077796e_MD5.webp)
...
![HTTP原理](img/4adcbf076ea91c0b0230eff20db78a6c_MD5.webp)

![RPC原理](img/462ecd3bde9a42290d30987d3aa7dd36_MD5.webp)
