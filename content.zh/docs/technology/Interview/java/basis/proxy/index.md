...
![Understanding the Proxy Design Pattern | by Mithun Sasidharan | Medium](img/204386cbc258c9ee874f86cd6cfda31d_MD5.jpg)

{{< html >}}<p style="text-align:right;font-size:13px;color:gray">https://medium.com/@mithunsasidharan/understanding-the-proxy-design-pattern-5e63fe38052a</p> {{< /html >}}
