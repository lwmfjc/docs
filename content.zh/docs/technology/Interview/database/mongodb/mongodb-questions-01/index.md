...
![MongoDB 文档](img/3929b15ceb1882fd4ea62c8e4eb856e7_MD5.jpg)
...
![BSON 官网首页](img/e0337ad2b449f196b143cbfc2aa63ff5_MD5.jpg)

#### 集合

MongoDB 集合存在于数据库中，==没有固定的结构==，也就是 ==无模式== 的，这意味着可以往集合插入不同格式和类型的数据。不过，通常情况下，插入集合中的数据都会有一定的关联性。

![MongoDB 集合](img/a9b6bbe340f938761568dabf70c0e31a_MD5.jpg)
...
![WiredTiger B+树整体结构](img/c5149bfef5e4347f9c7fcf6a837d0539_MD5.jpg)
...
![管道的工作流程](img/834d99541a017f99cdd38e41459e0bee_MD5.jpg)
