...
* 实例方法  
  * 如图  
  ![](img/ly-20241212142049410.png)
* 作用域  
  * 参数变量、局部变量、实例变量
  *  范围(如图)  
  ![](img/ly-20241212142049527.png)
* API、用例与实现  
  ...
  * 例子如下
    * API  
    ![](img/ly-20241212142049645.png)
    * 典型用例  
    ![](img/ly-20241212142049754.png)
    * 数据类型的实现  
    ![](img/ly-20241212142049860.png)
    * 使用方法(执行程序)  
      ![](img/ly-20241212142049969.png)

### 更多抽象数据类型的实现
* 日期  
  * 两种实现方式  
    ![](img/ly-20241212142050078.png)
...
* 例子，将二分法封装  
  * API  
  ![](img/ly-20241212142050191.png)
  * 典型的用例  
  ![](img/ly-20241212142050300.png)
  * 数据类型的实现  
  ![](img/ly-20241212142050413.png)
* 接口继承  
  * Java语言为定义对象之间的关系提供了支持，称为接口
  * 接口继承使得我们的程序能够通过调用接口中的方法操作实现该接口的任意类型的对象  
* 本书中使用到的接口  
![](img/ly-20241212142050528.png)
* 继承
  * 由Object类继承得到的方法  
  ![](img/ly-20241212142050645.png)
  * 继承toString()并自定义
  * 封装类型(内置的引用类型，包括Boolean、Byte、Character、Double、Float、Integer、Long和Short)
* 等价性  
  * 如图  
  ![](img/ly-20241212142050756.png)
  * 例子，在Date中重写equals  
  ![](img/ly-20241212142050900.png)
* 内存管理  
