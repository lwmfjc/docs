...
* Java程序的基本结构
  ...
  * 要执行一条Java程序，需要先用javac命令编译，然后用java命令运行，比如下面的文件，需要使用命令
      ...
      ![](img/ly-20241212142046412.png)  
      ![](img/ly-20241212142046572.png)  
