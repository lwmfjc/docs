...
- 泛型优先队列的API
  ![ly-20241212142058095](img/ly-20241212142058095.png)

- 优先队列的调用示例
  从N各输入中找到最大的M各元素所需成本
  ![ly-20241212142058324](img/ly-20241212142058324.png)
  ...
  - 应用
    ![ly-20241212142058429](img/ly-20241212142058429.png)
...
- 优先队列的各种实现在最坏情况下运行时间的增长数量级
  ![ly-20241212142058541](img/ly-20241212142058541.png)
- 在一个优先队列上执行的一系列操作如表2.4.4所示
  ![ly-20241212142058648](img/ly-20241212142058648.png)
...
- 图解
  ![ly-20241212142058750](img/ly-20241212142058750.png)

  ![ly-20241212142058853](img/ly-20241212142058853.png)
...
- 堆实现的比较和交换方法
  ...
  - 图解堆的操作
    ![ly-20241212142058954](img/ly-20241212142058954.png)
  ...
  - 说明
    ...
    - 在堆上进行操作
      ![ly-20241212142059057](img/ly-20241212142059057.png)
  ...
  - 索引优先队列
    ...
    ![ly-20241212142059162](img/ly-20241212142059162.png)
    ![ly-20241212142059264](img/ly-20241212142059264.png)
...
- 堆排序的轨迹（每次下沉后的数组内容）
  ![ly-20241212142059368](img/ly-20241212142059368.png)

- 堆排序：堆的构造（左）和下沉排序（右）
  ![ly-20241212142059470](img/ly-20241212142059470.png)
