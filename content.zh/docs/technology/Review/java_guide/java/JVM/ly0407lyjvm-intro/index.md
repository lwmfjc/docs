...
![img](img/ly-20241212142002924.png)
...
1. 类加载器
   ...
   ![img](img/ly-20241212142003190.png)
...
6. 小总结
   ![img](img/ly-20241212142003329.png)
...
![img](img/ly-20241212142003469.png)
...
![img](img/ly-20241212142003614.png)
...
- 如图，可使用的内存都是零零散散的，导致大内存对象问题
  ![img](img/ly-20241212142003749.png)
...
- 为了解决效率问题，出现了**复制**算法。将内存**按容量**划分成两等份，每次只使用其中的一块，**和survivor一样**用from和to两个指针。fromPlace存满了，就把存活对象copy到另一块toPlace上，然后交换指针内容，就解决了碎片问题
  ...
  ![img](img/ly-20241212142003888.png)
...
![img](img/ly-20241212142004027.png)
...
![img](img/ly-20241212142004166.png)
