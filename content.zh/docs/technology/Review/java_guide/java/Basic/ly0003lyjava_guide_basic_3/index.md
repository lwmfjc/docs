...
- Java异常类层次结构图
  ![ly-20241212141923567](img/ly-20241212141923567.png)

  ![ly-20241212141923848](img/ly-20241212141923848.png)
...
- 介绍
  ...
  - SPI扩展实现
    ![ly-20241212141924003](img/ly-20241212141924003.png)
- API和SPI区别
  ![ly-20241212141924162](img/ly-20241212141924162.png)
...
- 序列化的目的，通过网络传输对象，或者说是将对象存储到文件系统、数据库、内存中
  ![ly-20241212141924325](img/ly-20241212141924325.png)
