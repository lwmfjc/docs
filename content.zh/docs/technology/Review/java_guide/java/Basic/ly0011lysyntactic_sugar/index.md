...
![ly-20241212141927344](img/ly-20241212141927344.png)

int是比较数值，而char则是比较其ascii码，所以其实对于编译器来说，都是int类型(整型)，比如`byte`。`short`，`char`(ackii 码是整型)以及`int`。
![ly-20241212141927646](img/ly-20241212141927646.png)

![ly-20241212141927801](img/ly-20241212141927801.png)
而对于enum类型，  
![ly-20241212141927960](img/ly-20241212141927960.png)
