...
图示总结  
![ly-20241212141855666](img/ly-20241212141855666.png)
...
- 计算机只能存储**二进制**的数据，那**英文**、**汉字**、**表情**等字符应该如何存储呢
  - 我们要将这些**字符和二进制的数据一一对应**起来，比如说字符“a”对应“01100001”，反之，“01100001”对应 “a”。我们将字符对应二进制数据的过程称为"**字符编码**"，反之，二进制数据解析成字符的过程称为“**字符解码**”。    
    ...
    ![ly-20241212141855958](img/ly-20241212141855958.png)
...
- 总共128个，下面少了33个无法显示的**控制字符**
  ![ASCII字符编码](img/ly-20241212141856128.png)
...
![img](img/ly-20241212141856303.png)

乱码的本质：**编码**和**解码**时用了不同或者不兼容的字符集

![img](img/ly-20241212141856472.jpg)
...
- **UTF-8** 是目前使用最广的一种字符编码
  ![img](img/ly-20241212141856649.png)
...
- 使用```SHOW CHARSET```命令查看
  ![img](img/ly-20241212141856824.png)
...
- 为何会有两套UTF-8编码实现，原因如下
  ![img](img/ly-20241212141856995.png)
