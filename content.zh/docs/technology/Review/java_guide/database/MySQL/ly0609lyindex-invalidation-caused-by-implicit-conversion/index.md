...
数据如下所示：  
![img](img/ly-20241212141909903.png)
...
下面看1234的执行计划  
![img](img/ly-20241212141910111.png)
...
3. ★★
   ...
   3. 对第二点的后半部分再做解释  
      ...
      >
      > ![img](img/ly-20241212141910272.png)
      ...
      ![img](img/ly-20241212141910435.png)

      如此也就印证了之前的查询结果了

4. 再次写一条 SQL 查询 str1 字段：`SELECT * FROM`test1`WHERE str1 = 1234;`

   ![img](img/ly-20241212141910607.png)
