...
内部查询首先在其父查询之前执行，以便可以将内部查询的结果传递给外部查询。执行过程可以参考下图：
 ...
 ![img](img/ly-20241212141857794.jpg) 
...
下图展示了 LEFT JOIN、RIGHT JOIN、INNER JOIN、OUTER JOIN 相关的 7 种用法。
 ...
 ![ly-20241212141857961](img/ly-20241212141857961.png)
...
- 更改数据格式和表示。
 ...
 ![mysql视图](img/ly-20241212141858135.jpg) 
...
存储过程可以看成是对一系列 SQL 操作的批处理。存储过程可以由触发器，其他存储过程以及 Java， Python，PHP 等应用程序调用。
 ...
 ![mysql存储过程](img/ly-20241212141858306.jpg) 
...
![ly-20241212141858476](img/ly-20241212141858476.png)
