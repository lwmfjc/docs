...
- `@ComponentScan`： 扫描被`@Component` (`@Service`,`@Controller`)注解的 bean，注解默认会扫描启动类所在的包下所有的类 ，可以自定义不扫描某些 bean。如下图所示，容器中将排除`TypeExcludeFilter`和`AutoConfigurationExcludeFilter`。
  ...
  ![img](img/ly-20241212142012002.jpg)
...
![img](img/ly-20241212142012257.jpg)
...
![img](img/ly-20241212142012388.jpg)

**第 2 步** ：

用于获取`EnableAutoConfiguration`注解中的 `exclude` 和 `excludeName`。

![img](img/ly-20241212142012529.jpg)
...
![ly-20241212142012666](img/ly-20241212142012666.png)

从下图可以看到**这个文件的配置内容都被我们读取到了**。`XXXAutoConfiguration`的作用就是按需加载组件。

[![img](img/ly-20241212142012797.jpg)
...
![ly-20241212142012928](img/ly-20241212142012928.png)
...
[![img](img/ly-20241212142013064.jpg)](https://camo.githubusercontent.)
...
![img](img/ly-20241212142013197.jpg) 

第二步，引入 Spring Boot 相关依赖

[![img](img/ly-20241212142013329.jpg) 

第三步，创建`ThreadPoolAutoConfiguration`

 ![img](img/ly-20241212142013457.jpg) 

第四步，在`threadpool-spring-boot-starter`工程的 resources 包下创建`META-INF/spring.factories`文件

 ![ly-20241212142013597](img/ly-20241212142013597.png)

最后新建工程引入`threadpool-spring-boot-starter`

![ly-20241212142013730](img/ly-20241212142013730.png)

测试通过！！！

[![img](img/ly-20241212142013862.jpg) 
...
![image.png](img/ly-20241212142013995.png)
