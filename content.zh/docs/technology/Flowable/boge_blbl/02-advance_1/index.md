...
- 具体的
  ...
  - 流程历史记录
    ...
    ![ly-20241212142103886](img/ly-20241212142103886.png)

  - 流程定义表
    ![ly-20241212142104111](img/ly-20241212142104111.png)

  - 运行实例表
    ![ly-20241212142104209](img/ly-20241212142104209.png)

  - 用户用户组表

    ![ly-20241212142104309](img/ly-20241212142104309.png)

- 源码中的体现
  ![ly-20241212142104410](img/ly-20241212142104410.png)
...
- 把刚才的数据库清空，将flowable的配置文件放到目录custom/lycfg.xml中
  ![ly-20241212142104515](img/ly-20241212142104515.png)
