...
- 排他网关的绘制
  ![ly-20241212142113127](img/ly-20241212142113127.png)
  xml文件
...
- 运行
  ...
  - 数据库
    ![ly-20241212142113219](img/ly-20241212142113219.png)
...
- 此时再ran一个num为4的实例，然后张三完成，此时会走到总经理审批
  ...
  - 
    ![ly-20241212142113310](img/ly-20241212142113310.png)

- 注意，如果这里num设置为3，则会报错
  ![ly-20241212142113399](img/ly-20241212142113399.png)

- 两者区别
  ![ly-20241212142113492](img/ly-20241212142113492.png)
...
- 绘制流程图
  ![ly-20241212142113586](img/ly-20241212142113586.png)
...
- 并行网关的条件会被忽略
  ![ly-20241212142113676](img/ly-20241212142113676.png)
...
- 此时任务停留在zhangsan
  ![ly-20241212142113768](img/ly-20241212142113768.png)
...
- 查看表数据(一个任务包含多个执行实例)
  ![ly-20241212142113858](img/ly-20241212142113858.png)

- 让王五和李四进行审批
  查看数据库，wangwu审批后，act_ru_task就少了一条记录
  ![ly-20241212142113949](img/ly-20241212142113949.png)

- 此时走到总经理节点
  ![ly-20241212142114044](img/ly-20241212142114044.png)

- 图解
  ![ly-20241212142114134](img/ly-20241212142114134.png)
...
- 流程图
  ![ly-20241212142114223](img/ly-20241212142114223.png)
  xml
...
- 看数据，默认走人事和项目经理
  ![ly-20241212142114312](img/ly-20241212142114312.png)

- i1,i2所在任务执行完后，会发现走总经理
  i1走完之后
  ![ly-20241212142114403](img/ly-20241212142114403.png)
...
![ly-20241212142114501](img/ly-20241212142114501.png)
