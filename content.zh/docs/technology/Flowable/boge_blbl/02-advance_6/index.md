...
- 流程图绘制
  ![ly-20241212142114607](img/ly-20241212142114607.png)
...
- 依次完成1，2，3
  ...
  - 可以在这个表里让用户选择回退节点
    ![ly-20241212142114816](img/ly-20241212142114816.png)

  - 此时让user3再完成任务

  - 注：用下面的方法，不关心当前节点，只写明要跳转的结点即可
    ![ly-20241212142114907](img/ly-20241212142114907.png)
...
- 绘制
  ![ly-20241212142115000](img/ly-20241212142115000.png)
  ...
  - 查看部署的流程内置的表单
    ...
    - ![ly-20241212142115094](img/ly-20241212142115094.png)

  - 第一种启动方式，通过map
    ![ly-20241212142115185](img/ly-20241212142115185.png)
  ...
  - ```java
    ...
    - 注意查看act_ru_variable变量表
      ![ly-20241212142115274](img/ly-20241212142115274.png)
  ...
  - 查看完成的任务【主要】//有点问题，不管
    ![ly-20241212142115365](img/ly-20241212142115365.png)
