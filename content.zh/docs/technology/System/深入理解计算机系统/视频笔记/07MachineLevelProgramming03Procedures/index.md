---
title: 07MachineLevelProgramming03Procedures
description: 07MachineLevelProgramming03Procedures
categories:
  - 学习
tags:
  - 操作系统
  - 深入理解计算机系统
date: 2025-05-26T06:54:40+08:00
lastmod: 2025-05-26T06:54:40+08:00
cssAttach:
  - book03
cssclasses:
  - book03
...
![](img/ly-20250526143133957.png)  

![](img/ly-20250526143353362.png)  

![](img/ly-20250526143413399.png)  

![](img/ly-20250526143231854.png)   

![](img/ly-20250526143459381.png)  

# 关于寄存器的约定

![](img/ly-20250526144154348.png)  

- 如果调用者想要调用函数后再使用某寄存器的值，需要在==调用函数前保存==它
- 如果被调用者想要修改某寄存器，需要在==修改前保存，返回前恢复它的值==

## x86-64 LinuxRegisterUsage
### 调用者保存
~~允许被任意修改，无需恢复~~  
如果下列寄存器在==调用其他函数后还需用到原值==，==调用者自己要保存==  
![](img/ly-20250526144431629.png)  
### 被调用者保存
~~不允许被任意修改，如果被修改了，那么得在函数返回前恢复~~  
如果下列寄存器需要==被修改==，那么修改前得保存，函数返回前得恢复  
![](img/ly-20250526144740749.png)  
## 被调用者保存的示例
...
![](img/ly-20250526150651859.png)  

![](img/ly-20250526151309888.png)  
...
- (%ebx)任何计算结果是32位(四字节)的计算，会把寄存器==其余32位设置为0(高四字节)==

![](img/ly-20250526153321316.png)    
...
![](img/ly-20250527145353055.png)

*关于过程调用，你需要记住的就是栈原则*   

![](img/ly-20250527145724670.png)