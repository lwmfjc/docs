...
- 分类
  - 本地仓库（本机）：位于自己计算机中，磁盘中某个目录
    ...
    - 可修改
      ...
      备份并编辑
      ![ly-20241212142145669](img/ly-20241212142145669.png)
      改成左斜杠的方式
    ...
    - 下面的资源是从maven中下载，或者用maven打包的
      ![ly-20241212142145849](img/ly-20241212142145849.png)
  ...
  - mvn命令需要在pom.xml所在的目录下执行
    ![ly-20241212142145908](img/ly-20241212142145908.png)

## 仓库的工作方式

![ly-20241212142145966](img/ly-20241212142145966.png)
...
- 使用单元测试
  ...
  - 注意：mvn compile的时候，会下载3.8.2的jar包
    ![ly-20241212142146024](img/ly-20241212142146024.png)
...
- mvn clean ，清理，删除以前生成的数据（删除target目录）
  ![ly-20241212142146083](img/ly-20241212142146083.png)
...
- 代码的编译
  ...
  - 测试resources插件
    ![ly-20241212142146139](img/ly-20241212142146139.png)
    ![ly-20241212142146195](img/ly-20241212142146195.png)
...
- mvn test-compile:编译命令，编译src/test/java 目录中的源文件，把生成的class拷贝到target/test-classes目录中，同时把src/test/resources目录中的文件拷贝到test-classes目录
  命令执行前
  ![ly-20241212142146250](img/ly-20241212142146250.png)
  执行后
  ![ly-20241212142146310](img/ly-20241212142146310.png)
...
- mvn test 测试命令，执行test-classes目录的程序，测试src/main/java目录中的主程序是否符合要求
  ...
  测试报告
  ![ly-20241212142146369](img/ly-20241212142146369.png)

  - 测试失败的情况
    ![ly-20241212142146428](img/ly-20241212142146428.png)
...
- mvn package 打包，作用是把项目中的资源class文件和配置文件，都放到一个压缩包中，默认压缩文件是jar类型，web应用是war类型，扩展名jar/war
  ...
  - 生成ch01-maven-1.0-SNAPSHOT.jar
    ...
    查看jar
    ![ly-20241212142146483](img/ly-20241212142146483.png)
...
- mvn install 
  ...
  结果
  ![ly-20241212142146543](img/ly-20241212142146543.png)
